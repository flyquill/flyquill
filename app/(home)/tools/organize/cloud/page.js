            ...
            <div className="border border-gray-200 rounded-lg divide-y">
              ...
              <div className="p-4 flex items-center justify-between hover:bg-gray-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium">vacation-photo.jpg</p>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">3.5 GB of 10 GB used</p>
            </div>
            <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded transition-colors">
              Upgrade Storage
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-2">
              <button className="w-full text-left px-4 py-2 rounded hover:bg-gray-100 transition-colors flex items-center space-x-2">
