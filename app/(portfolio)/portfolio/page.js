    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="">
            ...
            <p className="hidden sm:block text-sm text-slate-400">
              Software Engineer • Accounting Systems • Full-stack
            </p>
          </div>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-4">
          ...
          <a
            href="/resume.pdf"
            className="inline-flex items-center gap-2 px-3 py-2 border border-slate-700 rounded-lg text-sm text-slate-300 hover:bg-slate-800 hover:border-slate-600 transition-colors"
          >
        ...
        <div
          className={`md:hidden fixed top-0 right-0 h-full w-64 bg-slate-800 shadow-lg z-50 transform ${
            menuOpen ? "translate-x-0" : "translate-x-full"
          } transition-transform border-l border-slate-700`}
        >
          <div className="p-4 bg-slate-800 min-h-screen">
            ...
            <nav className="mt-6 flex flex-col gap-3">
              <a
                onClick={() => setMenuOpen(false)}
                href="#projects"
                className="py-2 px-3 rounded text-slate-200 hover:bg-slate-700"
              >
                Projects
              </a>
              <a
              ...
              <a
                onClick={() => setMenuOpen(false)}
                href="/resume.pdf"
                className="py-2 px-3 rounded border border-slate-700 inline-flex items-center gap-2 text-slate-200 hover:bg-slate-700"
              >
                <FileText size={16} />
                Resume
              </a>
            ...
            <div className="mt-6 pt-4 border-t border-slate-700 text-sm text-slate-400">
              ...
              <div className="mt-3 flex gap-3">
                <a
                  href="https://github.com/flyquill/"
                  aria-label="github"
                ...
                <a
                  href="https://www.linkedin.com/in/muhammad-asad-67691b244/"
                  aria-label="linkedin"
                  className="hover:text-blue-400"
                >
                  <Linkedin size={18} />
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6">
        <section className="grid md:grid-cols-2 gap-10 items-center py-12 md:py-20">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 py-2 min-h-28">
              <TextType
                text={[
                  "Turning ideas into scalable solutions.",
                  "Building fast, modern web and mobile apps.",
                  "Design meets functionality in every line of code.",
          ...
          <motion.div
            ...
            className="bg-slate-800 rounded-2xl p-4 md:p-6 border border-slate-700"
          >
            <div className="relative overflow-hidden rounded-xl">
              <Image
                src="https://images.unsplash.com/photo-1508780709619-79562169bc64?auto=format&fit=crop&w=900&q=60"
                alt="hero"
                width={1200}
                height={720}
                className="w-full h-56 md:h-72 object-cover rounded-xl"
              />
              <div className="absolute bottom-4 left-4 bg-slate-900/80 backdrop-blur rounded-lg px-4 py-2 text-sm font-medium">
        ...
        <section id="projects" className="py-16">
          ...
          >
            Selected work that shows the range of what I deliver.
          </motion.p>
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {p.tech.map((t) => (
                      <span
                        key={t}
                        className="text-xs px-2.5 py-1 rounded-full bg-slate-700 text-slate-300"
                      >
                        {t}
                      </span>
                    ))}
        ...
        <section id="contact" className="py-16">
          ...
          <motion.p
            ...
            className="text-slate-400 mt-2"
          >
            Available for consulting, freelance, and full-time roles.
          </motion.p>
        ...
        <footer className="py-10 text-center text-sm text-slate-500 border-t border-slate-800">
          © {year} Muhammad Asad — Built with Next.js
        </footer>
      </main>
